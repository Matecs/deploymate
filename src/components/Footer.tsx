      ...
      <div className="container max-w-5xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-end gap-2">
            ...
            <a href="mailto:mate@datamate.hu" className="text-muted-foreground text-sm hover:text-foreground transition-colors">mate@datamate.hu</a>
            <a href="tel:+36204349647" className="text-muted-foreground text-sm hover:text-foreground transition-colors">+36 20 434 9647</a>
            <a href="https://datamate.hu" target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-sm hover:text-foreground transition-colors">DataMate.hu</a>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} DataMate</p>
